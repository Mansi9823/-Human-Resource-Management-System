...
<div class="col-md-4 control-label">
    ...
    <div class="input-group">
        ...
        <input type="file" name="pancard" title="PAN Card" class="form-control" name="fileupload">
    </div>
</div>
...
<div class="col-md-4 control-label">
    ...
    <div class="input-group">
        ...
        <input type="file" name="aadharcard" title="Aadhar Card" class="form-control" name="fileupload">
    </div>
</div>

<div class="col-md-4 control-label">
    <label class="control-label">Passbook*</label>
    <div class="input-group">
        <span class="input-group-addon">
            <i class="fa fa-book" aria-hidden="true"></i>
        </span>
        <input type="file" name="passbook" title="Passbook" class="form-control" name="fileupload">
    </div>
</div>

<div class="col-md-4 control-label">
    <label class="control-label">Transfer Certificate (TC)*</label>
    <div class="input-group">
        <span class="input-group-addon">
            <i class="fa fa-file" aria-hidden="true"></i>
        </span>
        <input type="file" name="tc" title="Transfer Certificate" class="form-control" name="fileupload">
    </div>
</div>

<div class="col-md-4 control-label">
    <label class="control-label">Marksheet*</label>
    <div class="input-group">
        <span class="input-group-addon">
            <i class="fa fa-file-text" aria-hidden="true"></i>
        </span>
        <input type="file" name="marksheet" title="Marksheet" class="form-control" name="fileupload">
    </div>
</div>
...
<div class="col-md-4 control-label">
    ...
    <div class="input-group">
        ...
        <input type="file" name="birthcertificate" title="Birth Certificate" class="form-control" name="fileupload">
    </div>
</div>
